...
Util.objFieldOnSetCallback = function (params) {
  ...
  if (typeof params.treatNullAsUnset !== 'undefined' && params.treatNullAsUnset === true) {
    // in other words: field value should not be equal to null
    params.fieldValue = null;
    params.fieldValueEquals = false;
  }
